...
/**
 * 	Um objeto <code>FicharioDeEmprestimos</code> mantém uma coleção de objetos
 *  da classe <code>Emprestimo</code>. 
 * 
 *	@author 	Luiz Alberto 
 *	@see 		{@link Emprestimo}
 */
public class FicharioDeEmprestimos {
	...
	/**
 	 * 	Obtem o nome do usuário que realizou um determinado 
     *  empréstimo.
 	 * 
 	 ...
 	 *	@throws EmprestimoNaoEncontradoException se o emprestimo 
 	 *			não for encontrado.
     *
 	 */
	...
	/**
 	 ...
 	 * 
     *	@throws EmprestimoNaoEncontradoException se o empréstimo 
 	 *			não for encontrado.
     *
 	 */
